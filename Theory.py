...
##___________Кортежи - используются для создания списка без изменяемых элементов. Занимает меньше места, чем список list. Поддерживает конкатенацию
...
set_ = {1,2,2,3,4,5,3,2,1,5,2,5} # повторов не будет
print(set_)